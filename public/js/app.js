...
function updateCart(cake) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/update-cart', cake).then(function (res) {
...
var errorMsg = document.querySelector('#error-alert');
...
function updateStatus(order) {
  ...
  statuses.forEach(function (status) {
    ...
    if (dataProp === order.status) {
      stepCompleted = false;
      time.innerText = moment__WEBPACK_IMPORTED_MODULE_1___default()(order.updateAt).format('hh:mm A');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return Object(_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__["loadStripe"])('pk_test_51JHqPXSEcbb14tFdTubBzC2rHuLpJi4yddvCLVEwZbprPTvbcPIU5prh7etmdZLe8XrVZwFXLVR2Prj8lnjFUCdh00xzskHOxr');
...
__webpack_require__(/*! C:\Users\Rachna\Desktop\BakeHeaven(with card)\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\Rachna\Desktop\BakeHeaven(with card)\resources\scss\app.scss */"./resources/scss/app.scss");
